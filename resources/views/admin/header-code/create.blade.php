        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-border-color card-border-color-primary">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.header-code.store') }}">
                            @csrf
                            ...
                            <div class="form-group pt-2">
                                ...
                                <textarea type="text"  class="form-control" rows="5" id="header_code"  name="header_code" placeholder="Enter header code  here" required></textarea>
                            </div>
